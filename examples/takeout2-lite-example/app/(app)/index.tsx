...
export default function Home() {
  return (
    <YStack flex={1} justify="center" items="center" p="$4" gap="$4" bg="$background">
      ...
      <Paragraph>
        Primary example for react-nibble, mirroring the Tamagui + One stack.
      </Paragraph>
      <SizableText size="$3" color="$color8">
        Shake the device or press Cmd+D to open the dev menu, then select
        &quot;Toggle react-nibble Inspector&quot; and tap a component.
      </SizableText>
